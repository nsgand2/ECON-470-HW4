...
for (y in 2008:2015) {
  ...
  for (m in monthlist) {
    ...
    ma.path=paste0("C:/Users/Nikhita Gandhe/Documents/GitHub/ECON-470-HW4/data/input/monthly-ma-state-and-county-penetration/State_County_Penetration_MA_",y,"_",m,".csv")
...
write_rds(ma.penetration.data,"C:/Users/Nikhita Gandhe/Documents/GitHub/ECON-470-HW4/data/output/ma_penetration.rds")